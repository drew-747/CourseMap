...
import { FaGlobe, FaFilePdf, FaFilePowerpoint } from "react-icons/fa";
...
const technicalContent = {
  "CS 10": {
    ...
    description:
      "History, components, and impact of computers. Data storage, trends, and issues in computing.",
    topics: [
    ...
    technicalDetails: {
      ...
      concepts: [
        ...
        },
        {
          ...
          examples: ["Binary", "Hexadecimal", "ASCII"],
        },
      ],
      practicalApplications: [
        {
          title: "Build a Simple Computer Model",
          description:
            "Diagram the parts of a computer and explain their functions.",
          code: "// Draw and label CPU, RAM, Storage, I/O",
        },
      ],
    },
  },
      ...
      concepts: [
        {
          ...
          examples: ["If-Else", "Loops", "Functions"],
        },
        {
          name: "Problem Solving",
          examples: ["Algorithm Design", "Debugging"],
        },
      ],
      practicalApplications: [
        {
  ...
  "CS 12": {
    ...
    description:
      "Object-oriented programming and advanced programming techniques in Java.",
    topics: [
      "OOP Principles",
      "Classes & Objects",
      "Inheritance",
      ...
      practicalApplications: [
        {
          ...
          description: "Create a system to manage student records using OOP.",
      ...
      practicalApplications: [
        {
          ...
          description: "Design and simulate a simple adder circuit.",
          code: "// Use logic simulator to build adder",
        },
      ],
    },
  },
  "CS 21": {
    ...
    description:
      "Study of computer hardware organization and architecture principles.",
    topics: [
      "CPU Architecture",
      "Memory Hierarchy",
      "I/O Systems",
    ...
    technicalDetails: {
      ...
      concepts: [
        { name: "CPU Design", examples: ["Pipelining", "Cache Memory"] },
        {
          ...
          examples: ["Registers", "Memory Operations"],
        },
      ],
      practicalApplications: [
        {
          title: "Assembly Program",
          description: "Write an assembly program to perform basic operations.",
          code: ".data\n    # Data section\n.text\n    # Code section",
        },
      ],
    },
      ...
      practicalApplications: [
        {
          ...
          description:
            "Implement a graph traversal algorithm with formal proofs.",
  ...
  "CS 31": {
    ...
    description:
      "Advanced discrete mathematics and probability for computer science.",
    topics: [
      "Probability Theory",
      "Statistics",
      "Number Theory",
      ...
      practicalApplications: [
        {
          ...
          description:
            "Implement a basic cryptographic system with formal security proofs.",
    ...
    technicalDetails: {
      ...
      concepts: [
        { name: "Data Structures", examples: ["Linked Lists", "Binary Trees"] },
        {
          ...
          examples: ["Big O Notation", "Complexity Analysis"],
        },
      ],
      practicalApplications: [
        {
    ...
    technicalDetails: {
      ...
      concepts: [
        { name: "Graph Algorithms", examples: ["Dijkstra", "Kruskal"] },
        {
          ...
          examples: ["Memoization", "Tabulation"],
        },
      ],
      practicalApplications: [
        {
          ...
          code: "// Dijkstra's algorithm implementation",
        },
      ],
    },
  },
  "CS 132": {
    ...
    technicalDetails: {
      ...
      concepts: [
        {
          name: "Data Analysis",
          examples: ["Data Cleaning", "Feature Engineering"],
        },
        {
      ...
      practicalApplications: [
        {
          ...
          description: "Implement a simple automata simulator.",
          code: "// Automata simulation code",
        },
      ],
    },
  },
      ...
      practicalApplications: [
        {
          ...
          description:
            "Implement numerical methods for solving equations with error bounds.",
      ...
      practicalApplications: [
        {
          ...
          description:
            "Implement a parallel numerical solver with performance analysis.",
      ...
      practicalApplications: [
        {
          ...
          description: "Implement a simple process scheduler.",
          code: "// Process scheduling implementation",
        },
      ],
    },
  },
      ...
      practicalApplications: [
        {
          ...
          description: "Implement a basic language interpreter.",
  ...
  "CS 153": {
    ...
    technicalDetails: {
      ...
      practicalApplications: [
        {
          title: "Security Tool",
          description: "Implement a basic security tool.",
      ...
      practicalApplications: [
        {
          ...
          description: "Implement a basic compiler for a small language.",
      ...
      practicalApplications: [
        {
          ...
          description: "Create a database-driven application.",
  ...
  "CS 180": {
    ...
    technicalDetails: {
      ...
      practicalApplications: [
        {
          title: "AI Model",
          description: "Implement a simple AI model.",
      ...
      practicalApplications: [
        {
          ...
          description: "Develop a software project following SE principles.",
  ...
  "CS 192": {
    ...
    technicalDetails: {
      ...
      practicalApplications: [
        {
          title: "Team Project",
          description: "Develop a team software project.",
          code: "// Team project implementation",
        },
      ],
    },
  },
      ...
      concepts: [
        {
          ...
          examples: ["Experimental Design", "Data Analysis"],
        },
        {
          name: "Academic Writing",
          examples: ["Paper Structure", "Citations"],
        },
      ],
      practicalApplications: [
        {
          title: "Research Paper",
          description: "Write a research paper on a CS topic.",
          code: "// Research paper in LaTeX",
        },
      ],
    },
  },
      ...
      practicalApplications: [
        {
          ...
          description: "Complete an industry project.",
          code: "// Industry project implementation",
        },
      ],
    },
  },
    ...
    technicalDetails: {
      ...
      concepts: [
        { name: "Ethics", examples: ["Privacy", "Security"] },
        {
          ...
          examples: ["Codes of Conduct", "Best Practices"],
        },
      ],
      practicalApplications: [
        {
          title: "Ethics Case Study",
          description: "Analyze and present an ethics case study.",
      ...
      practicalApplications: [
        {
          ...
          description: "Develop the first part of the capstone project.",
          code: "// Project implementation",
        },
      ],
    },
  ...
  "CS 199": {
    ...
    technicalDetails: {
      ...
      concepts: [
        {
          ...
          examples: ["Final Testing", "Deployment"],
        },
      ...
      practicalApplications: [
        {
          title: "Final Project",
          description: "Complete and present the capstone project.",
          code: "// Final project implementation",
        },
      ],
    },
  },
...
function CourseDetailModal({
  ...
  const [courseResources, setCourseResources] = useState(resources);

  // Fetch resources from Firestore when the modal opens
  useEffect(() => {
    const fetchResources = async () => {
      if (courseCode) {
        const docRef = doc(db, "courses", courseCode); // Firestore document for the course
        const docSnap = await getDoc(docRef);
        if (docSnap.exists()) {
          setCourseResources(docSnap.data().resources || []);
        }
      }
    };
  ...
  // Add a new resource and update Firestore
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-neutral-600 dark:text-neutral-400">
                  {course
                    ? course.description
                    : "No detailed information available for this course."}
                </p>
              </div>
              <button
                onClick={onClose}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {course.technicalDetails.languages.map(
                          (lang, index) => (
                            <span
                              key={index}
...
>>>>>>> 15bf001f8d30fae25712707bd06120b261ff35e4
                    </div>
                  ))}
                </div>
              </div>
...
=======
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {course.technicalDetails.practicalApplications.map(
                      (app, index) => (
                        <div
                          key={index}
                          className="bg-neutral-50 dark:bg-neutral-700/50 rounded-lg p-4"
...
>>>>>>> 15bf001f8d30fae25712707bd06120b261ff35e4
              ...
              {bestPractices.length > 0 ? (
                <ul className="space-y-2">
                  {bestPractices.map((bp, idx) => (
                    <li
                      key={idx}
                      className="bg-yellow-50 dark:bg-yellow-900/30 rounded-lg p-3"
                    >
                ...
                <div className="text-neutral-500 text-sm">
                  No best practices or insights available for this course yet.
                </div>
              )}
            </div>
              ...
              <ul className="space-y-2">
                {courseResources.map((res, idx) => (
                  <li key={idx} className="flex items-center space-x-2">
                    {/* Display the appropriate icon based on the resource type */}
                    <span>
                      {res.type === "website" && (
            ...
            {showAddResource && (
              <div className="mt-4 space-y-2">
                <input
                  ...
                  className="w-full px-3 py-2 border rounded bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white"
                />
                <input
                  type="url"
                ...
                <button
                  ...
                  className="mt-2 px-4 py-2 bg-primary text-white rounded hover:bg-primary-light transition"
                >
                  Add Resource
                </button>
              </div>
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-primary text-white rounded hover:bg-primary-light transition"
            >
              {showAddResource ? "Cancel" : "Add a Resource"}
            </button>

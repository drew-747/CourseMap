...
import { GitBranch, GitMerge, Book, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
            Your personalized guide through the UP Computer Science curriculum.
            Track your progress and plan your academic journey with ease.
          </p>
        </motion.div>

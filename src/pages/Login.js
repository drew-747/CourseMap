...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isSignUp && studentNumber.length !== 9) {
      setError("Student Number must be a valid UP Student Number");
      setIsLoading(false);
      return;
    }
            ...
            {isSignUp && (
              <>
                <AnimatedInput
                  ...
                  error={error && error.includes("Student Number") ? error : ""}
                />
                <AnimatedInput
                  type="text"
                  value={firstName}
                ...
                <AnimatedInput
                  ...
                  error={error && error.includes("current year") ? error : ""}
                />
              </>
            )}
          {/* Login Form */}
